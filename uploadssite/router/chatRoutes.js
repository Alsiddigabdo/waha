...
const { uploadChat, uploadAvatar } = require('../config/multerConfig');
...
// إرسال رسالة جديدة
router.post("/chat/sendMessage", uploadChat.single("imagePath"), ChatController.sendMessage);
...
router.post("/updateAvatar", uploadAvatar.single("avatar"), ChatController.updateAvatar);
